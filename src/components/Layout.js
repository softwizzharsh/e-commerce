              ...
              {cartItems?.map((product) => {
                return (
                  <li class="list-group-item d-flex justify-content-between lh-sm">
                    <div>
                      <h6 class="my-0">{product.productId.productname}</h6>
        ...
        <div class="container-fluid">
          <div class="row py-3 border-bottom">
            ...
            <div class="col-sm-8 col-lg-4 d-flex justify-content-end gap-5 align-items-center mt-4 mt-sm-0 justify-content-center justify-content-sm-end">
              ...
              <div class="support-box justify-content-center d-none d-xl-flex">
                <img src={userProfile} width={50} />
                <div>
                  <span class="fs-6 text-muted">
                    {userInfo?.firstName || "userName"}
                  </span>
                  <h5 class="mb-0"> {userInfo?.email || "user@gmail.com"}</h5>
                </div>
              </div>
                ...
                >
                  ...
                  <div class="offcanvas-body">
                    ...
                    <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
                      {mainCategories.map((val) => {
                        return (
                          <li class="nav-item active" key={val._id}>
                            <Link
                              class="nav-link"
          ...
          <div class="row">
              ...
              <div class="footer-menu">
                ...
                <div class="social-links mt-5">
                  <ul class="d-flex list-unstyled gap-2">
                    <li>
                      <Link to="https://www.facebook.com/" class="btn btn-light">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                          height="16"
                    ...
                    <li>
                      <Link to='https://www.x.com/' class="btn btn-light">
                    ...
                    <li>
                      <Link to="https://www.youtube.com/" class="btn btn-light">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                          height="16"
                    ...
                    <li>
                      <Link to="https://www.instagram.com/" class="btn btn-light">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                          height="16"
                    ...
                    <li>
                      <Link to="https://www.amazon.in/" target="_blank" class="btn btn-light">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                          height="16"
            ...
            <div class="col-md-2 col-sm-6">
              <div class="footer-menu">
                ...
                <ul class="menu-list list-unstyled">
                  ...
                  {mainCategories.map((val) => {
                    return (
                      <li key={val._id} class="menu-item">
                        <Link
                          to={`product/${val._id}?isName=mainCategory`}
                          class="nav-link"
                        >
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="footer-menu">
                ...
                <p>
                  Stay updated with the latest battery deals, warranty offers,
                  and new product launches. Get exclusive discounts delivered
