                ...
                <div class="banner-ad large bg-info block-1">
                  <div class="swiper main-swiper">
                      ...
                      <SwiperSlide>
                        <div class="row banner-content p-5">
                          <div class="content-wrapper col-md-7">
                            <div class="categories my-3">100% hello  natural</div>
                            <h3 class="display-4">
                    ...
                    <div class="row banner-content p-5">
                      ...
                      <div class="img-wrapper col-md-5">
                        <img src={require('../images/product-thumb-1.png')} class="img-fluid" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="swiper-slide">
                    <div class="row banner-content p-5">
                      ...
                      <div class="img-wrapper col-md-5">
                        <img src={require('../images/product-thumb-2.png')} class="img-fluid" />
                      </div>
                    </div>
                  </div> */}
                    {/* </div> */}
                  ...
                  <div class="row banner-content p-5">
                    <div class="content-wrapper col-md-7">
                      ...
                      <a href="#" class="d-flex align-items-center nav-link">
                        Shop Collection{" "}
                      <svg width="24" height="24"><use xlinkHref="#arrow-right"></use></svg>
                      </a>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-md-12">
              <div class="products-carousel swiper">
                <Swiper
                  ...
                  slidesPerView={6}
                  loop={true}
                  onSwiper={setSwiperInstance2} // Set the Swiper instance when it's initialized
                ...
                <div class="col-md-6 p-5">
                  <div class="section-header">
                    <h2 class="section-title display-4">
                      Get <span class="text-primary">25% Discount</span> on your
                      first purchase
                    </h2>
                  </div>
                  <p>
            ...
            <div class="col-md-4">
              <article class="post-item card border-0 shadow-sm p-3">
                <div class="image-holder zoom-effect">
                  <a href="#">
                    <img
                      src={require("../images/post-thumb-1.jpg")}
                      alt="post"
                      class="card-img-top"
                    />
                  </a>
            ...
            <div class="col-md-4">
              <article class="post-item card border-0 shadow-sm p-3">
                <div class="image-holder zoom-effect">
                  <a href="#">
                    <img
                      src={require("../images/post-thumb-2.jpg")}
                      alt="post"
                      class="card-img-top"
                    />
                  </a>
            ...
            <div class="col-md-4">
              <article class="post-item card border-0 shadow-sm p-3">
                <div class="image-holder zoom-effect">
                  <a href="#">
                    <img
                      src={require("../images/post-thumb-3.jpg")}
                      alt="post"
                      class="card-img-top"
                    />
                  </a>
