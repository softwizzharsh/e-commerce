...
import jsVectorMap from '../assets/js/jvectormap.min.js';
import '../assets/js/world-merc.js';
export default function Dashboard()
{
  const Chart = require('../assets/js/Chart.min.js');
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-7">
              <div class="card-style mb-30">
                ...
                {/* End Title */}
                <div class="chart">
                  <canvas ref={chart1Ref} id="Chart1" style={{'width': '100%', 'height': '400px', 'marginLeft': '-35px'}}></canvas>
                </div>
                {/* End Chart */}
              </div>
            </div>
            ...
            <div class="col-lg-5">
              <div class="card-style mb-30">
                ...
                {/* End Title */}
                <div class="chart">
                  <canvas  ref={chart2Ref} id="Chart2" style={{'width': '100%', 'height': '400px', 'marginLeft': '45px'}}></canvas>
                </div>
                {/* End Chart */}
              </div>
            </div>
            ...
            <div class="col-lg-7">
              <div class="card-style mb-30">
                ...
                <div class="chart">
                  ...
                  <canvas ref={chart3Ref} id="Chart3" style={{'width': '100%', 'height': '450px', 'marginLeft': '-35px'}}></canvas>
                </div>
              </div>
            </div>
            {/* End Col */}
            <div class="col-lg-5">
              <div class="card-style mb-30">
                ...
                <div class="chart">
                  ...
                  <canvas ref={chart4Ref} id="Chart4" style={{'width': '100%', 'height': '420px', 'marginLeft': '-35px'}}></canvas>
                </div>
                {/* End Chart */}
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-lg-5">
              ...
              <FullCalendar
        plugins={[dayGridPlugin]} // Use DayGrid plugin
        initialView="dayGridMonth" // Initial view is the month view
        headerToolbar={{
          start: 'prev,next today', // prev/next buttons
          center: 'title', // Title in the center
          end: 'dayGridMonth,dayGridWeek,dayGridDay', // View buttons
        }}
        // events={[
